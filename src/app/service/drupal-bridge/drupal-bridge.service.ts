...
export class DrupalBridgeService {
  ...
  public getNodeById(id: string): Observable<Node> {
    ...
    return this.http.get<Node>(`${this.nodeUrl}/node/${id}`, options);
  }
  ...
  public getNodeByPath(path: string): Observable<Node> {
    ...
    return this.http.get<Node>(this.removeDuplication(`${this.nodeUrl}/${path}`), options);
  }
  ...
  public getUserById(id: string): Observable<User> {
    ...
    return this.http.get<User>(`${this.nodeUrl}/user/${id}`, options);
  }
  ...
  private requestUserByUid(uid: Uid): Observable<User> {
    ...
    return this.http.get<User>(this.removeDuplication(`${this.nodeUrl}${uid.url}`), options);
  }

  private removeDuplication(url) {
